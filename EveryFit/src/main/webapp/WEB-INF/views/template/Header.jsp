	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarColor01">
			<ul class="navbar-nav me-auto">
				...
				<li class="nav-item">
					<h1>
						<a class="nav-link ms-3" href="/member/login">
				...
				<li class="nav-item dropdown">
					<a	class="nav-link dropdown-toggle ms-3" data-bs-toggle="dropdown" href="#"
					role="button" aria-haspopup="true" aria-expanded="false">
					<h2><i class="fa-solid fa-users-gear mt-2" ></i></h2>
					</a>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="${pageContext.request.contextPath}/moim/create">
						모임 만들기
						</a>
						<a class="dropdown-item" href="${pageContext.request.contextPath}/moim/detail?moimNo=5">
						모임상세(테스트용)
						</a>
						...
						<div class="dropdown-divider"></div>
						<a	class="dropdown-item" href="${pageContext.request.contextPath}/pay?productNo=1">
						프리미엄회원권(테스트용)
						</a>
						<a	class="dropdown-item" href="${pageContext.request.contextPath}/pay?productNo=2">
						프리미엄회원권(테스트용)
						</a>
					</div></li>
			</ul>
