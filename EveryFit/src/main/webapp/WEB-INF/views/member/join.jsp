<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="row">
		...
		<div class="col-md-4 offset-md-4 text-center">
			email<input type="text" name="memberEmail" placeholder="everyfit@every.fit" id="id"  class="form-control">
			<button type="button" id="id_Confirm" value="중복확인" class="btn btn-success">중복검사</button>
		</div>
		...
		<div class="col-md-4 offset-md-4 text-center">
			contact<input type="text" name="memberContact" class="form-control">
		</div>
		...
		<div class="mt-4 col-md-4 offset-md-4 text-center" style="margin-bottom: 150px;">
