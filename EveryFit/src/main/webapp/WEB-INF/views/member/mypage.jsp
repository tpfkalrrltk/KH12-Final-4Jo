...
<div class="container-fluid ">
	<div class="row">
		<div
			...
			<div class="row mt-5 p-3 border border-primary rounded shadow-sm">
				<div class="col">
					<div class="row m-1">
						<div class="col-4">
							<div class="row">
								<div class="col">
									<c:choose>
										...
										<c:otherwise>
											<img
												src="${pageContext.request.contextPath}/rest/attach/download?attachNo=${profile}"
												class="rounded-circle border shadow-sm bg-dark profile-image w-100"
												id="profileImage"
							...
							<div class="row mt-2 text-center">
								<div class="col">
									<label> <input type="file" class="profile-chooser "
										...
										class="fa-solid fa-camera-retro text-primary fa-2x"></i>
									</label> <i
										class="ms-2 fa-regular fa-trash-can text-danger fa-2x profile-delete"></i>
								</div>
							</div>
						</div>
						<div class="col-8">
							...
							<div class="row ms-2">
								<div class="col">
									<i class="fa-solid fa-user-group"></i> 가입한 모임 : ${moimCount} /
									${memberDto.memberMoimCount} 개
								</div>
							</div>
							<div class="row mt-5 ms-2">
								<div class="col">
									<c:choose>
										<c:when test="${memberDto.memberLevel == '프리미엄'}">
											<a href="${pageContext.request.contextPath}/pay/list"
												class="btn btn-primary w-100">보유중인 프리미엄</a>
										</c:when>
										<c:otherwise>
											<a href="${pageContext.request.contextPath}/pay?productNo=1"
												class="btn btn-primary w-100">프리미엄 회원권 구매</a>
										</c:otherwise>
									</c:choose>
								</div>
							</div>
							<div class="row mt-2 ms-2">
								<div class="col">
									<a href="${pageContext.request.contextPath}/member/change"
										class="btn btn-primary w-100"> 프로필 수정 </a>
								</div>
							</div>
						</div>
						<div class="row">
										...
										<div class="card-body">
											...
											<div class="row mt-4">
												<div class="col-5 offset-1">
													<a
														href="${pageContext.request.contextPath}/moim/detail?moimNo=${moimDto.moimNo}"
														class="btn btn-primary w-100">모임 상세</a>
												</div>
												<div class="col-5">
													<a
														href="${pageContext.request.contextPath}/default/${moimDto.chatRoomNo}"
