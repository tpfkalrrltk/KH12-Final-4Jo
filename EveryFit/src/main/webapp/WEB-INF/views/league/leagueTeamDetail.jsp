				...
				<div class="row text-center">
					<div class="col-2">
						<a href="${pageContext.request.contextPath}/league/leagueTeamDetail?leagueTeamNo=${matchDto.leagueMatchHome}">
							<img src="${pageContext.request.contextPath}/league/leagueTeamImage?leagueTeamNo=${matchDto.leagueMatchHome}" class="object-fit-cover rounded w-100 m-2"
					...
					<div class="col-2">
						<a href="league/leagueTeamDetail?leagueTeamNo=${matchDto.leagueMatchAway}">
							<img src="${pageContext.request.contextPath}/league/leagueTeamImage?leagueTeamNo=${matchDto.leagueMatchAway}" class="object-fit-cover rounded w-100 m-2"
								onerror="this.onerror=null; this.src='/images/no-image.png';">
						</a>
					</div>
					<div class="row"><div class="col">
