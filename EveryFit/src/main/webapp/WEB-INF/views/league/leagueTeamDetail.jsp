	...
	<div class="row"><div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1">
		<div class="p-5 bg-primary text-light rounded mb-5">
			...
			<div class="row mt-4 text-end"><div class="col">
				<a href="/moim/detail?moimNo=${moimDto.moimNo}" class="btn btn-outline-success bg-light">모임정보</a>
				<a href="leagueDetail?leagueNo=${leagueDto.leagueNo}" class="btn btn-outline-success bg-light">리그페이지</a>
			</div></div>
		</div>
