...
public class ReportAttachRestController {
	...
	@PostMapping("/upload")
	public Map<String, Object> upload(HttpSession session, @RequestParam int reportNo,
		...
		adminDao.deleteReportImage(reportNo);
		adminDao.insertReportImage(reportNo, attachDto.getAttachNo());
	...
	@PostMapping("/delete")
	public void delete(HttpSession session, @RequestParam int reportNo) {
		adminDao.deleteReportImage(reportNo);
	}
