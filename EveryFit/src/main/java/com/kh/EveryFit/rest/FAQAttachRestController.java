...
@CrossOrigin
@RestController
@RequestMapping("faq/rest/attach")
public class FAQAttachRestController {
	...
	public Map<String, Object> upload(HttpSession session, @RequestParam int freeBoardNo,
		...
		faqDao.deleteFreeBoardImage(freeBoardNo);
		faqDao.insertFreeBoardImage(freeBoardNo, attachDto.getAttachNo());
